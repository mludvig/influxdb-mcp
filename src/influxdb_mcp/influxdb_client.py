...
class InfluxDBManager:
    ...
    # def get_recent_data(self, bucket: str, measurement: str, limit: int = 100,
    ...
    #     '''
    #     data = self._query_api.query( # type: ignore
    #         query, org=self.config.org
    #     )
    #     return json.loads(TableList(data).to_json())

    # def query_data_range(self, bucket: str, measurement: str, start_time: str,
